...
import { Container, Row, Col, Input, Card, Form, Media, Collapse, Label } from "reactstrap"
...
const EcommerceAddProduct = () => {
    ...
    const handleFile = acceptedFile => {
        console.log(acceptedFile, "vô day ko")
        acceptedFile.map(file => Object.assign(file, {
            preview: URL.createObjectURL(file),
            formattedSize: formatBytes(file.size)
        }))

        setselectedFiles(acceptedFile)
    }
                                            ...
                                            <Media className="d-flex align-items-center">
                                                <div className="me-3">
                                                    <div className="avatar-xs">
                                                        <div className="bg-soft-primary avatar-title rounded-circle text-primary">
                                                            01
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="flex-1 overflow-hidden">
                                                    ...
                                                    <p className="mb-0 text-muted text-truncate"> Fill all information below </p>
                                                </div>
                                        ...
                                        <div className="p-4 border-top">
                                            <Form>
                                                ...
                                                <Row>
                                                    ...
                                                    <Col lg={4}>
                                                        <div className="mb-3">
                                                            <Label htmlFor="manufacturerband">Manufacturer Brand</Label>
                                                            <Input
                                                                id="manufacturerband"
                                                                name="manufacturerband"
                                                                type="text"
                                                                className="form-control"
                                                            />
                                                        </div>
